...
JOB_PROFILES_LIST = (
    {
        ...
        'file_prefix': 'lumo',
        'file_indexes': np.arange(0, 2+1, 20),
        'plot_title_suffix': f"",
        'ieos': 10,
        'params': {
            'X' : 0.691,
        ...
        'name': f"APR non-dusty 1.7{Msun_str}",
        'nickname': '2ma',
        'color': 'blue',
    },
    {
        'raw_dir' : '../raw/clmu_2ma/',
        'file_prefix': 'star',
        'file_indexes': np.arange(0, 420+1, 20),
        'plot_title_suffix': f"",
        'ieos': 10,
        'params': {
            'X' : 0.691,
        ...
        'name': f"APR non-dusty 1.7{Msun_str} single",
        'nickname': '2ma-star',
        'color': 'blue',
    },
    {
        ...
        'file_prefix': 'lumo',
        'file_indexes': np.arange(0, 1120+1, 20),
        'plot_title_suffix': f"",
        'ieos': 2,
        'params': {
            'X' : 0.691,
        ...
        'name': f"APR non-dusty ideal-gas 1.7{Msun_str}",
        'nickname': '2ia',
        'color': 'blue',
    },
    {
        'raw_dir' : '../raw/clmu_2iaf/bugfix87d8/',
        'file_prefix': 'star',
        'file_indexes': np.arange(0, 1100+1, 20),
        'plot_title_suffix': f"",
        'ieos': 2,
        'params': {
            'X' : 0.691,
        ...
        'name': f"APR non-dusty ideal-gas 1.7{Msun_str} single",
        'nickname': '2ia-star',
        'color': 'blue',
    },
    {
        'raw_dir' : '../raw/miguel_2i/',
        'file_prefix': 'binary',
        'file_indexes': np.arange(0, 1000+1, 20),
        'plot_title_suffix': f"",
        'ieos': 2,
        'params': {
            'X' : 0.691,
        ...
        'name': f"Non-dusty ideal-gas 1.7{Msun_str}",
        'nickname': '2i',
        'color': 'blue',
    },
    {
